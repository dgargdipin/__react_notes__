...
var Student = function (_Person) {
    ...
    _createClass(Student, [{
        ...
        key: 'getDescription',
        value: function getDescription() {
            if (!this.hasMajor()) return _get(Student.prototype.__proto__ || Object.getPrototypeOf(Student.prototype), 'getDescription', this).call(this);
...
var me = new Student('Dipin', 20, 'CSE');
var other = new Student();
var traveller1 = new Traveller('t1', 20, 'Delhi');
var traveller2 = new Traveller('t2', 20);
